...
class MostPopularCell: UICollectionViewCell {
    ...
    override func awakeFromNib() {
        ...
        //Name
        name.adjustLabel(text: "", textColor: .white, fontSize: 18, fontType: .regular)
        // Main Image
        mainImage.contentMode = .scaleAspectFit
        backgroundImage.contentMode = .scaleToFill
        //Rate
        rateImage.image = UIImage(systemName: "star.fill")?.withTintColor(.white)
        rateLabel.adjustLabel(text: "", textColor: .white, fontSize: 12, fontType: .regular)
        //Location
        locationLabel.adjustLabel(text: "", textColor: .white, fontSize: 16, fontType: .regular)
